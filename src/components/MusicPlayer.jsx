...
const MusicPlayer = () => {
  return (
    <div className="flex flex-col px-5 w-[100%] border-2 border-black py-3 bg-[#232A4E] rounded-xl mt-5 ">
      {/* upper part */}
      ...
      <div className="flex items-center justify-between mt-5">
        {/* track */}
        <div className="flex flex-col justify-between text-sm text-gray-500 flex-[2] ">
